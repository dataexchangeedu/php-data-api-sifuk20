...
/**
 * TTSubject Class Doc Comment
 *
 * @category    Class
 * @description A subject used on the timetable. This may or may not be a subject stored in the MIS yet.
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class TTSubject implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TTSubject';
    ...
    /**
     * Sets description
     * @param string $description This is the description of the subject (long name). The recommended maximum length of the string is 32 characters.
     * @return $this
     */
