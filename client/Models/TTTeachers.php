...
/**
 * TTTeachers Class Doc Comment
 *
 * @category    Class
 * @description Collection of TTTeacher records
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class TTTeachers implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'TTTeacher';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'TTTeachers';
