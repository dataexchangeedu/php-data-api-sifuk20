...
/**
 * SchoolGroupTypes Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class SchoolGroupTypes implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'SchoolGroupType';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SchoolGroupTypes';
