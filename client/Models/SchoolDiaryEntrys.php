...
/**
 * SchoolDiaryEntrys Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class SchoolDiaryEntrys implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'SchoolDiaryEntry';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SchoolDiaryEntrys';
