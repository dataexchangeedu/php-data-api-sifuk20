...
/**
 * LearnerBehaviourIncidents Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class LearnerBehaviourIncidents implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'LearnerBehaviourIncident';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'LearnerBehaviourIncidents';
