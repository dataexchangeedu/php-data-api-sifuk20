...
/**
 * AssessmentResultComponentGroups Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class AssessmentResultComponentGroups implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'AssessmentResultComponentGroup';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'AssessmentResultComponentGroups';
