...
/**
 * TermInfos Class Doc Comment
 *
 * @category    Class
 * @description Collection of TermInfo records
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class TermInfos implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'TermInfo';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'TermInfos';
