...
/**
 * AssessmentSessions Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class AssessmentSessions implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'AssessmentSession';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'AssessmentSessions';
