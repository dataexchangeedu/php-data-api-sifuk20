...
/**
 * AlternativeTuition Class Doc Comment
 *
 * @category    Class
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class AlternativeTuition implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlternativeTuition';
    ...
    /**
     * Sets category
     * @param string $category Reason for alternative tuition.
     * @return $this
     */
    ...
    /**
     * Sets start_date
     * @param \DateTime $start_date Beginning date for alternative tuition.
     * @return $this
     */
    ...
    /**
     * Sets end_date
     * @param \DateTime $end_date End date for alternative tuition.
     * @return $this
     */
    ...
    {
        return isset($this->container['total_hours']) ? $this->container['total_hours'] : null;
    }

    /**
     * Sets total_hours
     * @param int $total_hours The total number of hours provided for with the tuition.
     * @return $this
     */
    ...
    {
        return isset($this->container['provision_type']) ? $this->container['provision_type'] : null;
    }

    /**
     * Sets provision_type
     * @param string $provision_type Alternative tuition provision type.
     * @return $this
     */
