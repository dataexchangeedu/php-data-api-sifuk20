...
/**
 * AssessmentResultComponentGroup Class Doc Comment
 *
 * @category    Class
 * @description High level container describing an assessment or test or common goal. Each component group contains one or more components, also known as subtests, aspects, or sub-assessments.
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class AssessmentResultComponentGroup implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AssessmentResultComponentGroup';
    ...
    /**
     * Sets ref_id
     * @param string $ref_id The ID (GUID) that uniquely identifies a component group.
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name Name of the assessment/test/goal.
     * @return $this
     */
