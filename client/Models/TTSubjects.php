...
/**
 * TTSubjects Class Doc Comment
 *
 * @category    Class
 * @description Collection of TTSubject records
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class TTSubjects implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'TTSubject';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'TTSubjects';
