...
/**
 * WorkforceContracts Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class WorkforceContracts implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'WorkforceContract';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'WorkforceContracts';
