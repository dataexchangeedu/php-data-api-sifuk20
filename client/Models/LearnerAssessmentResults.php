...
/**
 * LearnerAssessmentResults Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class LearnerAssessmentResults implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'LearnerAssessmentResult';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'LearnerAssessmentResults';
