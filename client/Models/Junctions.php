...
/**
 * Junctions Class Doc Comment
 *
 * @category    Class
 * @description Collection of Junction records
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class Junctions implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'Junction';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'Junctions';
