 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Posts implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'Posts';
    ...
    /**
     * Sets post
     * @param string $post The post assigned to the workforce member in the context of the school or LA.
     * @return $this
     */
