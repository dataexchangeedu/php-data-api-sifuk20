...
/**
 * PersonDietaryPreferences Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class PersonDietaryPreferences implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'PersonDietaryPreference';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PersonDietaryPreferences';
