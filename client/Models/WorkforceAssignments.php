...
/**
 * WorkforceAssignments Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class WorkforceAssignments implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'WorkforceAssignment';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'WorkforceAssignments';
