...
/**
 * PersonPictures Class Doc Comment
 *
 * @category    Class
 * @description Collection of PersonPicture records
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class PersonPictures implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'PersonPicture';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PersonPictures';
