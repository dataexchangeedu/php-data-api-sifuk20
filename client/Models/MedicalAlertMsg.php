...
/**
 * MedicalAlertMsg Class Doc Comment
 *
 * @category    Class
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class MedicalAlertMsg implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MedicalAlertMsg';
    ...
    {
        return isset($this->container['severity']) ? $this->container['severity'] : null;
    }

    /**
     * Sets severity
     * @param string $severity The level of severity of this medical alert.
     * @return $this
     */
