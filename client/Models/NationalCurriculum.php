...
/**
 * NationalCurriculum Class Doc Comment
 *
 * @category    Class
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class NationalCurriculum implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NationalCurriculum';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['modification'] === null) {
            $invalid_properties[] = "'modification' can't be null";
        }
    ...
    {
        return isset($this->container['modification']) ? $this->container['modification'] : null;
    }

    /**
     * Sets modification
     * @param string $modification How is the National Curriculum used for this learner?
     * @return $this
     */
    ...
    {
        return isset($this->container['subject']) ? $this->container['subject'] : null;
    }

    /**
     * Sets subject
     * @param string $subject National Curriculum subject(s) for which modification or disapplication applies.
     * @return $this
     */
