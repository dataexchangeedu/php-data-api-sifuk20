...
/**
 * SIFExtendedElement Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SIFExtendedElement implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SIF_ExtendedElement';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["StartDate", "EndDate", "DayName"];
        if (!in_array($this->container['name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'name', must be one of 'StartDate', 'EndDate', 'DayName'.";
        }
    ...
    {
        $allowed_values = array('StartDate', 'EndDate', 'DayName');
        if ((!in_array($name, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'name', must be one of 'StartDate', 'EndDate', 'DayName'");
        }
