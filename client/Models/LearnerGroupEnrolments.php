...
/**
 * LearnerGroupEnrolments Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class LearnerGroupEnrolments implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'LearnerGroupEnrolment';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'LearnerGroupEnrolments';
