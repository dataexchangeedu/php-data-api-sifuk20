...
/**
 * TeachingGroups Class Doc Comment
 *
 * @category    Class
 * @description Collection of TeachingGroup records
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class TeachingGroups implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'TeachingGroup';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'TeachingGroups';
