...
class SIFExtendedElement2 implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["StartDate", "EndDate"];
        if (!in_array($this->container['name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'name', must be one of 'StartDate', 'EndDate'.";
        }
    ...
    {
        $allowed_values = array('StartDate', 'EndDate');
        if ((!in_array($name, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'name', must be one of 'StartDate', 'EndDate'");
        }
