...
/**
 * ExternalLearnerIdentifier Class Doc Comment
 *
 * @category    Class
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class ExternalLearnerIdentifier implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalLearnerIdentifier';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['identifier_type'] === null) {
            $invalid_properties[] = "'identifier_type' can't be null";
        }
    ...
    {
        return isset($this->container['identifier_type']) ? $this->container['identifier_type'] : null;
    }

    /**
     * Sets identifier_type
     * @param string $identifier_type A code that defines the type of identifier.
     * @return $this
     */
