...
/**
 * SchoolGroups Class Doc Comment
 *
 * @category    Class
 * @description Collection of SchoolGroup records
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class SchoolGroups implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'SchoolGroup';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SchoolGroups';
