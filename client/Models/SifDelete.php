 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SifDelete implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'sifDelete';
    ...
    public function setStatusCode($status_code)
    {
        ...
        if (!is_null($status_code) && (!preg_match("/[24-5][0-9]{2}/", $status_code))) {
            throw new \InvalidArgumentException("invalid value for $status_code when calling SifDelete., must conform to the pattern /[24-5][0-9]{2}/.");
        }
