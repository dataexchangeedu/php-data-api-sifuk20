 ...
 * @link        https://developer.dataexchange.education
 */
class Reason implements ArrayAccess
{
    ...
    /**
     * Sets code
     * @param string $code The attendance code.
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type The attendance code type.
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param string $status The authorised status of the attendance code.
     * @return $this
     */
    ...
    {
        return isset($this->container['total']) ? $this->container['total'] : null;
    }

    /**
     * Sets total
     * @param int $total The total number of sessions attributed to this reason between StartDate and EndDate for the specified reason.
     * @return $this
     */
