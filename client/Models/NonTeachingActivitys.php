...
/**
 * NonTeachingActivitys Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class NonTeachingActivitys implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'NonTeachingActivity';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'NonTeachingActivitys';
