...
/**
 * SifCreateResponse Class Doc Comment
 *
 * @category    Class
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class SifCreateResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sifCreateResponse';
    ...
    protected static $swaggerTypes = [
        'creates' => '\DataExchange\SIFUK20\Models\SifCreates'
    ];
    ...
    {
        $this->container['creates'] = isset($data['creates']) ? $data['creates'] : null;
    }
    ...
    /**
     * Gets creates
     * @return \DataExchange\SIFUK20\Models\SifCreates
     */
    public function getCreates()
    {
        return isset($this->container['creates']) ? $this->container['creates'] : null;
    }

    /**
     * Sets creates
     * @param \DataExchange\SIFUK20\Models\SifCreates $creates
     * @return $this
     */
    public function setCreates($creates)
    {
        $this->container['creates'] = $creates;
