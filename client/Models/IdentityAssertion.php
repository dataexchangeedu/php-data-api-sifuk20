...
/**
 * IdentityAssertion Class Doc Comment
 *
 * @category    Class
 * @description The identification string for this user.
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class IdentityAssertion implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IdentityAssertion';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['schema_name'] === null) {
            $invalid_properties[] = "'schema_name' can't be null";
        }
    ...
    {
        return isset($this->container['schema_name']) ? $this->container['schema_name'] : null;
    }

    /**
     * Sets schema_name
     * @param string $schema_name The name of the field.
     * @return $this
     */
