...
/**
 * LearnerAssessmentResponseSets Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class LearnerAssessmentResponseSets implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'LearnerAssessmentResponseSet';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'LearnerAssessmentResponseSets';
