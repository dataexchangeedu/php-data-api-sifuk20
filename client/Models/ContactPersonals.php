...
/**
 * ContactPersonals Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class ContactPersonals implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'ContactPersonal';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ContactPersonals';
