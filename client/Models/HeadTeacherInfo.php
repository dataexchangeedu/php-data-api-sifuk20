...
/**
 * HeadTeacherInfo Class Doc Comment
 *
 * @category    Class
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class HeadTeacherInfo implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HeadTeacherInfo';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contact_name'] === null) {
            $invalid_properties[] = "'contact_name' can't be null";
        }
    ...
    {
        return isset($this->container['contact_name']) ? $this->container['contact_name'] : null;
    }

    /**
     * Sets contact_name
     * @param string $contact_name The name of the head Teacher.
     * @return $this
     */
    ...
    {
        return isset($this->container['contact_title']) ? $this->container['contact_title'] : null;
    }

    /**
     * Sets contact_title
     * @param string $contact_title The official title of the Head Teacher.
     * @return $this
     */
