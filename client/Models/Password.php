...
class Password implements ArrayAccess
{
    ...
    {
        return isset($this->container['algorithm']) ? $this->container['algorithm'] : null;
    }

    /**
     * Sets algorithm
     * @param string $algorithm The method used to encrypt the user&#039;s password. See the implementation details below.
     * @return $this
     */
    ...
    {
        return isset($this->container['key_name']) ? $this->container['key_name'] : null;
    }

    /**
     * Sets key_name
     * @param string $key_name The name of the key to be used for decryption of the password. Left blank for hash algorithms (MD5 and SHA1).
     * @return $this
     */
