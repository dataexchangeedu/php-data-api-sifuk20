...
/**
 * BehaviourType Class Doc Comment
 *
 * @category    Class
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class BehaviourType implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BehaviourType';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['weighting'] === null) {
            $invalid_properties[] = "'weighting' can't be null";
        }
    ...
    /**
     * Sets classification
     * @param string $classification Agreed Classification for this behaviour type
     * @return $this
     */
     ...
     * @param string $sub_classification Free text string to precisely define the type of behaviour (if classification is Other then sub classification is mandatory else optional)
     * @return $this
     */
