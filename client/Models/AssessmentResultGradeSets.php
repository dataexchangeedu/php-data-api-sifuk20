...
/**
 * AssessmentResultGradeSets Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class AssessmentResultGradeSets implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'AssessmentResultGradeSet';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'AssessmentResultGradeSets';
