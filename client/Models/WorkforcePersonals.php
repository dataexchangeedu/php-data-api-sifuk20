...
/**
 * WorkforcePersonals Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class WorkforcePersonals implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'WorkforcePersonal';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'WorkforcePersonals';
