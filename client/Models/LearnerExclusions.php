...
/**
 * LearnerExclusions Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class LearnerExclusions implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'LearnerExclusion';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'LearnerExclusions';
