...
/**
 * WorkforceAbsences Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://developer.dataexchange.education
 */
class WorkforceAbsences implements ArrayAccess
{
    const DISCRIMINATOR = null;

    const IS_ARRAY = true;
    const ITEMS = 'WorkforceAbsence';

    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'WorkforceAbsences';
