...
/**
 * TTRoom Class Doc Comment
 *
 * @category    Class
 * @description A room (or learning space) used on the timetable. This may or may not be a &amp;quot;real&amp;quot; room stored in the MIS yet.
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class TTRoom implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TTRoom';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['site_ref_id'] = isset($data['site_ref_id']) ? $data['site_ref_id'] : null;
    }
    ...
    /**
     * Sets description
     * @param string $description This is the description of the room (long name) It is used by the MIS to help the user manually match to a room in the MIS (or decide on some other appropriate action). The recommended maximum length of the string is 32 characters.
     * @return $this
     */
     ...
     * @return string
     */
    public function getSiteRefId()
    {
        return isset($this->container['site_ref_id']) ? $this->container['site_ref_id'] : null;
    }

    /**
     * Sets site_ref_id
     * @param string $site_ref_id Which &quot;site&quot; this room is on. It may also be used by the MIS. References the TTSite object.
     * @return $this
     */
    public function setSiteRefId($site_ref_id)
    {
        $this->container['site_ref_id'] = $site_ref_id;
