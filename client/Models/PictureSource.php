...
/**
 * PictureSource Class Doc Comment
 *
 * @category    Class
 * @description This element defines the picture. If the Type attribute is URL, this is the location of the picture in [JPEG] format; if Type is JPEG, this is the [JPEG] image data encoded using the Base64 Content-Transfer-Encoding defined in Section 6.8 of [RFC 2045].
 * @package     DataExchange\SIFUK20
 * @author      DataExchange team
 * @link        https://developer.dataexchange.education
 */
class PictureSource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PictureSource';
    ...
    /**
     * Sets type
     * @param string $type The way the picture is specified (URL or JPEG).
     * @return $this
     */
