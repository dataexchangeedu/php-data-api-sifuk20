...
class ApiClient
{
     ...
     */
    public function __construct(\DataExchange\UK\20\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \DataExchange\UK\20\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\DataExchange\UK\20\ObjectSerializer::sanitizeForSerialization($postData));
        }
