...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://uk.staging.dataexchange.education/rest/sif/requests';
     ...
     * @var string
     */
    protected $userAgent = 'DataExchange/2.3.0/php';
    ...
    {
        $report  = 'PHP SDK (DataExchange\SIFUK20) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.0.0.20170813191457' . PHP_EOL;
