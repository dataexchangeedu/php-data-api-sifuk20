...
For more information, please visit [https://support.dataexchange.eduation](https://support.dataexchange.eduation)
...
```php
    require_once('/path/to/DataExchange\SIFUK20/autoload.php');
```
