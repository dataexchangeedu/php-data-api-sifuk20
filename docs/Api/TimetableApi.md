...
[**deleteSchoolGroupTypes**](TimetableApi.md#deleteSchoolGroupTypes) | **DELETE** /SchoolGroupTypes | Delete multiple SchoolGroupTypes
...
[**getScopes**](TimetableApi.md#getScopes) | **GET** /Scopes | Return all Scopes
...
[**updateTTSubjectByRefId**](TimetableApi.md#updateTTSubjectByRefId) | **PUT** /TTSubjects/{RefId} | Update TTSubject by RefId
...
# **getCycles**
> \DataExchange\SIFUK20\Models\Cycles getCycles($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getCycles($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
...
# **getJunctions**
> \DataExchange\SIFUK20\Models\Junctions getJunctions($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getJunctions($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    ...
    echo 'Exception when calling TimetableApi->getLearnerSchoolEnrolments: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getLessonByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getLessons**
> \DataExchange\SIFUK20\Models\Lessons getLessons($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getLessons($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getLessons: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getNonTeachingActivityByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \DataExchange\SIFUK20\Models\NonTeachingActivitys getNonTeachingActivitys($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getNonTeachingActivitys($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getNonTeachingActivitys: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getSchoolDiaryEntryByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \DataExchange\SIFUK20\Models\SchoolDiaryEntrys getSchoolDiaryEntrys($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getSchoolDiaryEntrys($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getSchoolDiaryEntrys: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getSchoolGroupByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getSchoolGroupTypeByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getSchoolGroupTypes**
> \DataExchange\SIFUK20\Models\SchoolGroupTypes getSchoolGroupTypes($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getSchoolGroupTypes($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getSchoolGroupTypes: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getSchoolGroups**
> \DataExchange\SIFUK20\Models\SchoolGroups getSchoolGroups($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getSchoolGroups($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getSchoolGroups: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getScopeByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getScopes**
> \DataExchange\SIFUK20\Models\Scopes getScopes($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getScopes($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getScopes: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getTTRoomByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getTTRooms**
> \DataExchange\SIFUK20\Models\TTRooms getTTRooms($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getTTRooms($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getTTRooms: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getTTSiteByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getTTSites**
> \DataExchange\SIFUK20\Models\TTSites getTTSites($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getTTSites($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getTTSites: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getTTSubjectByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getTTSubjects: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getTTTeacherByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getTTTeachers**
> \DataExchange\SIFUK20\Models\TTTeachers getTTTeachers($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getTTTeachers($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getTTTeachers: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getTeachingGroupByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getTeachingGroups: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->getTermInfoByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getTermInfos**
> \DataExchange\SIFUK20\Models\TermInfos getTermInfos($navigation_page, $navigation_page_size, $zone_id)
...
try {
    $result = $api_instance->getTermInfos($navigation_page, $navigation_page_size, $zone_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TimetableApi->getTermInfos: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateCycleByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateCycles: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateJunctionByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateJunctions: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateLearnerGroupEnrolmentByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateLearnerGroupEnrolments: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateLearnerSchoolEnrolmentByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateLearnerSchoolEnrolments: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateLessonByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateLessons: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateNonTeachingActivityByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateNonTeachingActivitys: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateSchoolDiaryEntryByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateSchoolDiaryEntrys: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateSchoolGroupByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateSchoolGroupTypeByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateSchoolGroupTypes: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateSchoolGroups: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateScopeByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateScopes: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTTRoomByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTTRooms: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTTSiteByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTTSites: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTTSubjectByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTTSubjects: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTTTeacherByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTTTeachers: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTeachingGroupByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTeachingGroups: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTermInfoByRefId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling TimetableApi->updateTermInfos: ', $e->getMessage(), PHP_EOL;
}
?>
```
